...
namespace UrlShortener
{
    public static class Function1
    {
            ...
            ILogger log)
        {
            ...
            UrlData url = new UrlData { PartitionKey = code[0].ToString(), RowKey = code, Count = 1, Url = href };
            urlKey.Id++;
            ...
            await tableOut.ExecuteAsync(oper);
            return href != null
                ? (ActionResult)new OkObjectResult($"Вы ввели: {href}, сформирован короткий адрес: {url.RowKey}")
                : new BadRequestObjectResult("Передайте href в строке или в теле запроса");
        }
